...
test("青山实验中 uses the Qianshan network-backend experiment route", () => {
  ...
  const main = fs.readFileSync(path.join(repositoryRoot, "electron", "main.js"), "utf8");
  ...
  assert.match(main, /WANSHAN_QINGSHAN_EXPERIMENT/);
  assert.match(main, /qianshanOnly=1/);
